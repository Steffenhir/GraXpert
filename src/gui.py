...
class Application(tk.Frame):
    ...
    def create_widget(self):
        ...
        text.image = num_pic
        text.grid(column=0, row=0, pady=(20*sf,5*sf), padx=0, sticky="w")
        ...
        self.load_image_button.grid(column=0, row=1, pady=(5*sf,30*sf), padx=15*sf, sticky="news")
        ...
        text.image = num_pic
        text.grid(column=0, row=2, pady=5*sf, padx=0, sticky="w")
        ...
        self.stretch_menu.grid(column=0, row=3, pady=(5*sf,30*sf), padx=15*sf, sticky="news")
        ...
        text.image = num_pic
        text.grid(column=0, row=4, pady=5*sf, padx=0, sticky="w")
        ...
        self.bg_selection_text.grid(column=0, row=5, pady=(5*sf,0), padx=15*sf, sticky="ews")
        ...
        self.bg_pts_slider.grid(column=0, row=6, pady=(0,0), padx=15*sf)
        ...
        self.bg_selection_tol.grid(column=0, row=7, pady=(0,0), padx=15*sf, sticky="ews")
        ...
        self.bg_tol_slider.grid(column=0, row=8, pady=(0,0), padx=15*sf)
        ...
        self.bg_selection_button.grid(column=0, row=9, pady=5*sf, padx=15*sf, sticky="news")
        ...
        self.reset_button.grid(column=0, row=10, pady=(5*sf,30*sf), padx=15*sf, sticky="news")
        ...
        text.image = num_pic
        text.grid(column=0, row=11, pady=5*sf, padx=0, sticky="w")
        
        self.intp_type_text = tk.Message(self.side_menu, text="Interpolation Method:")
        self.intp_type_text.config(width=500)
        self.intp_type_text.grid(column=0, row=12, pady=(5*sf,0), padx=15*sf, sticky="ews")
        ...
        self.interpol_menu.grid(column=0, row=13, pady=(0,5*sf), padx=15*sf, sticky="news")
        ...
        self.smooth_text.grid(column=0, row=14, pady=(5*sf,0), padx=15*sf, sticky="ews")
        ...
        self.smoothing_slider.grid(column=0, row=15, pady=(0,5*sf), padx=15*sf)
        ...
        self.calculate_button.grid(column=0, row=16, pady=(5*sf,30*sf), padx=15*sf, sticky="news")
        ...
        self.saveas_text.grid(column=0, row=17, pady=5*sf, padx=0, sticky="w")
        ...
        self.saveas_menu.grid(column=0, row=18, pady=(5*sf,20*sf), padx=15*sf, sticky="news")
        ...
        self.save_background_button.grid(column=0, row=19, pady=5*sf, padx=15*sf, sticky="news")
        ...
        self.save_button.grid(column=0, row=20, pady=(5*sf,10*sf), padx=15*sf, sticky="news")
